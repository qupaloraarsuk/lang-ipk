...
This directory contains source files for the Inupiaq language morphology
...
-   <https://giellalt.uit.no/lang/ipk/index.html> (analyser)
...
The Inupiaq language sources can be acquired using [giella SVN
